# Terms of Service for StudyLess

**Last Updated:** December 17, 2025

## Agreement to Terms

By accessing or using the StudyLess mobile application ("App," "Service," or "StudyLess"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our App.

## Description of Service

StudyLess is an educational mobile application that helps students:
- Create and organize digital flashcards
- Generate flashcards using AI technology
- Study using spaced repetition algorithms
- Track study progress and performance

## Eligibility

You must be at least 13 years old to use StudyLess. If you are under 18, you confirm that you have obtained parental or guardian consent to use this App.
...
- Report any security breaches to us immediately

## User Content

### Your Content

You retain ownership of all content you create or upload to StudyLess, including:
- Flashcard questions and answers
- Study notes and materials
- Images and documents uploaded for AI generation

### License to Us

By uploading content to StudyLess, you grant us a limited license to:
- Store and display your content within the App
- Process your content to provide services (e.g., AI flashcard generation)
- Back up your content for data protection
- Use anonymized, aggregated content to improve our services
...
- Infringes on the privacy or safety of others

## Acceptable Use

You agree to use StudyLess only for lawful purposes. You will NOT:

1. **Violate Laws** - Use the App in any way that violates local, state, national, or international law
2. **Misuse Services** - Attempt to reverse engineer, decompile, or hack the App
3. **Interfere** - Disrupt or interfere with the security or functionality of the App
4. **Impersonate** - Pretend to be someone else or misrepresent your affiliation
5. **Spam** - Use automated systems to access the App without permission
6. **Exploit** - Use the App for unauthorized commercial purposes
7. **Abuse** - Harass, threaten, or harm other users

## AI-Generated Content

### AI Flashcard Generation

- Our AI uses Google Gemini to process images and generate flashcards
- AI-generated content may contain errors or inaccuracies
- You are responsible for reviewing and verifying AI-generated content
- We do not guarantee the accuracy or completeness of AI-generated flashcards

### Your Responsibility

- Always review AI-generated flashcards before studying
- Verify information against reliable sources
- Do not rely solely on AI-generated content for critical exams or decisions

## Intellectual Property Rights

### Our Rights

All rights, title, and interest in StudyLess, including:
...
are owned by us or our licensors and are protected by copyright, trademark, and other laws.

### Restrictions

You may NOT:
- Copy, modify, or distribute our App code
...
Currently, StudyLess is offered free of charge during the beta period.
...
- Your actions harm other users or our services
...
StudyLess is provided "AS IS" and "AS AVAILABLE" without warranties of any kind, either express or implied, including:
- No guarantee of uninterrupted or error-free service
- No warranty of accuracy or reliability of content
- No guarantee of specific results or outcomes

### Educational Tool

StudyLess is an educational tool to assist with studying. It is not:
- A substitute for professional educational advice
- A guarantee of academic success
- Responsible for exam or test outcomes
...
- Damages from errors or inaccuracies in content
...
Any disputes not resolved informally shall be resolved through binding arbitration in accordance with [ARBITRATION_RULES], except where prohibited by law.
